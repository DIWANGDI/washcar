...
@property(nonatomic,copy)NSString                   *O_RefundInfo;
@property(nonatomic,copy)NSString                   *O_RefundImage1;
@property(nonatomic,copy)NSString                   *O_RefundImage2;
@property(nonatomic,copy)NSString                   *O_RefundMoney;
@property(nonatomic,copy)NSString                   *O_RefundTicket;
...
@property(nonatomic,copy)NSString                   *O_AgentID;
