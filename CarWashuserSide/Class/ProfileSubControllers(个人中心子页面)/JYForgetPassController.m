...
@interface JYForgetPassController ()
{
...
@implementation JYForgetPassController
...
-(void)registerMethod
{
    NSMutableDictionary *parms=[@{
                                  ...
                                  @"U_PwdNew":user_SetPass.text
                                  }mutableCopy];
    [[KGNetworkManager sharedInstance] invokeNetWorkAPIWith:KNetWorkResetPassWord withUserInfo:parms success:^(NSDictionary *message,NSString *errorMsg,NSString *okStr)
     {
